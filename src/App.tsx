...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-dark-bg text-gray-900 flex flex-col relative select-none">
      ...
      <header className="sticky top-0 z-40 bg-dark-bg/85 backdrop-blur-md border-b border-dark-border py-4 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <span className="hidden sm:block text-[10px] font-mono tracking-wider text-gray-500">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-6 md:px-12 py-12 z-10">
        ...
        <div className="text-center mb-12 max-w-2xl mx-auto">
          ...
          <motion.h1
            ...
            className="text-4xl md:text-5xl font-display font-extrabold text-gray-900 tracking-tight"
          >
        ...
        <div className="bg-dark-card border border-dark-border rounded-xl p-4 md:p-6 mb-10 flex flex-col md:flex-row items-center justify-between gap-5">
          ...
          <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
            <span className="text-[10px] font-mono text-gray-400 uppercase mr-2 flex items-center gap-1">
              ...
              <button
                ...
                className={`text-xs font-mono px-3 py-1.5 rounded-md transition-colors duration-200 ${
                  selectedCategory === category
                    ...
                    : 'bg-dark-bg border border-dark-border text-gray-500 hover:text-gray-900'
                }`}
          ...
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="w-full bg-dark-bg border border-dark-border rounded-lg pl-9 pr-3 py-2 text-xs text-gray-900 focus:outline-none focus:border-gold-500 transition-colors duration-200 placeholder-gray-500"
        ...
        {(selectedLead || selectedCategory !== 'All' || searchQuery) && (
          <div className="flex flex-wrap items-center gap-2 mb-6 text-xs text-gray-500 bg-dark-card/50 px-4 py-2.5 rounded-lg border border-dark-border/40 w-fit">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {filteredServices.length === 0 ? (
              <div className="bg-dark-card border border-dark-border p-12 text-center rounded-2xl">
                <span className="text-gray-300 block text-2xl mb-2">🔍</span>
      ...
      <div className="lg:hidden fixed bottom-6 right-6 z-40">
        ...
        >
          ...
          {plannerServiceIds.length > 0 && (
            <span className="absolute -top-1 -right-1 bg-red-500 text-gray-900 font-mono text-[10px] font-bold w-5 h-5 rounded-full flex items-center justify-center">
          ...
          <div className="lg:hidden fixed inset-0 z-50 overflow-hidden">
            ...
            >
              <div className="flex justify-end mb-2">
                <button
                  onClick={() => setIsMobilePlannerOpen(false)}
                  className="p-1 rounded-full bg-dark-bg text-gray-500 hover:text-gray-900"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
